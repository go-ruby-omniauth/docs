# go-ruby-omniauth documentation

**Pure-Go, MRI-4.0.5-faithful Ruby omniauth (no cgo)**

`go-ruby-omniauth/omniauth` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `omniauth`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `omniauth`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`omniauth`](https://github.com/go-ruby-omniauth/omniauth) | the library — Ruby's `omniauth` in pure Go |
| [`docs`](https://github.com/go-ruby-omniauth/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-omniauth.github.io`](https://github.com/go-ruby-omniauth/go-ruby-omniauth.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-omniauth/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-omniauth/omniauth](https://github.com/go-ruby-omniauth/omniauth).
