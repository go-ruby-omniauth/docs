...
The public API lives at the module root (`github.com/go-ruby-omniauth/omniauth`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `omniauth`, while the surface follows
...
```go
import "github.com/go-ruby-omniauth/omniauth"
```
...
- **[pkg.go.dev/github.com/go-ruby-omniauth/omniauth](https://pkg.go.dev/github.com/go-ruby-omniauth/omniauth)**

The module's [README](https://github.com/go-ruby-omniauth/omniauth#readme) carries worked
