...
Contributions are welcome. `go-ruby-omniauth/omniauth` is built to a small set of
...
The library is in [`github.com/go-ruby-omniauth/omniauth`](https://github.com/go-ruby-omniauth/omniauth).
This documentation site is in [`github.com/go-ruby-omniauth/docs`](https://github.com/go-ruby-omniauth/docs).
